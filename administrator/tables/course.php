 ...
 * course Table class
 */
class FeeTablecourse extends JTable {
    ...
    public function bind($array, $ignore = '') {
        ...
        if (($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state', 'com_fee.course.' . $array['id']) && $array['state'] == 1)) {
            $array['state'] = 0;
        }
        if ($array['id'] == 0) {
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_fee.course.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_fee', 'course');
            $default_actions = JFactory::getACL()->getAssetRules('com_fee.course.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetName() {
        ...
        return 'com_fee.course.' . (int) $this->$k;
    }
