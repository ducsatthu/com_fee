 ...
 * View to edit
 */
class FeeViewSemester extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_FEE_TITLE_SEMESTER'), 'semester.png');
        ...
        if (!$isNew && $canDo->get('core.create')) {
            JToolBarHelper::custom('semester.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
        }
