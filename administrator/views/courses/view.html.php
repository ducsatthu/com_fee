 ...
 */
class FeeViewCourses extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_FEE_TITLE_COURSES'), 'courses.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_fee&view=courses');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_FEE_COURSES_TITLE'),
		);
	}
