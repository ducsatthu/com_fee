...
<script type="text/javascript">
    ...
    {
        if (task == 'year.cancel') {
            Joomla.submitform(task, document.getElementById('year-form'));
        }
        else {
            
            if (task != 'year.cancel' && document.formvalidator.isValid(document.id('year-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_fee&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="year-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_FEE_TITLE_YEAR', true)); ?>
        <div class="row-fluid">
