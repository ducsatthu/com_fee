...
class FeeViewReceipt extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_FEE_TITLE_RECEIPT'), 'receipt.png');
        ...
        if (!$checkedOut && ($canDo->get('core.create'))) {
            JToolBarHelper::custom('receipt.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
        }
