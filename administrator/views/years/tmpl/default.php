...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_fee&task=years.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'yearList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="yearList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'years.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
