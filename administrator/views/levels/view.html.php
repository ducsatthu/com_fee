 ...
 */
class FeeViewLevels extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_FEE_TITLE_LEVELS'), 'levels.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/level';
        ...
        if ($canDo->get('core.edit.state')) {
            ...
            if (isset($this->items[0]->state)) {
                ...
                JToolBarHelper::deleteList('', 'levels.delete', 'JTOOLBAR_DELETE');
            }
            ...
            if (isset($this->items[0]->checked_out)) {
                JToolBarHelper::custom('levels.checkin', 'checkin.png', 'checkin_f2.png', 'JTOOLBAR_CHECKIN', true);
            }
        }
        ...
        JHtmlSidebar::setAction('index.php?option=com_fee&view=levels');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_FEE_LEVELS_TITLE'),
		);
	}
