...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_fee&task=levels.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_fee&view=levels'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="levelList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FEE_LEVELS_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
