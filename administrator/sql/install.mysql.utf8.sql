...
**/
INSERT INTO `#__content_types` (`type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) 
SELECT 'course', 'com_fee.course', '{"special": {"dbtable": "#__fee_course","key": "id","type": "course","prefix":"FeeTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common": {"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"},"special":{}}', 'FeeHelperRoute::getCourseRoute', '{"formFile":"administrator\\/components\\/com_fee\\/models\\/forms\\/course.xml", "hideFields": ["asset_id","checked_out","checked_out_time","access"], "ignoreChanges": [ "checked_out", "checked_out_time"],"convertToInt": [], "displayLookup": [{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"}]}'
FROM DUAL
WHERE NOT EXISTS (SELECT `type_alias` FROM `#__content_types` WHERE `type_alias`='com_fee.course');

/** Support Content history 
	__fee_department
**/
INSERT INTO `#__content_types` (`type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) 
SELECT 'department', 'com_fee.department', '{"special": {"dbtable": "#__fee_department","key": "id","type": "department","prefix":"FeeTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common": {"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"},"special":{}}', 'FeeHelperRoute::getDepartmentRoute', '{"formFile":"administrator\\/components\\/com_fee\\/models\\/forms\\/department.xml", "hideFields": ["asset_id","checked_out","checked_out_time","access"], "ignoreChanges": [ "checked_out", "checked_out_time"],"convertToInt": [], "displayLookup": [{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"department_alias","targetTable":"#__fee_department","targetColumn":"alias","displayColumn":"title"}]}'
FROM DUAL
WHERE NOT EXISTS (SELECT `type_alias` FROM `#__content_types` WHERE `type_alias`='com_fee.department');

/** Support Content history 
	fee_level
**/
INSERT INTO `#__content_types` (`type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) 
SELECT 'level', 'com_fee.level', '{"special": {"dbtable": "#__fee_level","key": "id","type": "level","prefix":"FeeTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common": {"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"},"special":{}}', 'FeeHelperRoute::getLevelRoute', '{"formFile":"administrator\\/components\\/com_fee\\/models\\/forms\\/level.xml", "hideFields": ["asset_id","checked_out","checked_out_time","access"], "ignoreChanges": [ "checked_out", "checked_out_time"],"convertToInt": [], "displayLookup": [{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"}]}'
FROM DUAL
WHERE NOT EXISTS (SELECT `type_alias` FROM `#__content_types` WHERE `type_alias`='com_fee.level');

/** Support Content history 
	__fee_fee
**/
INSERT INTO `#__content_types` (`type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) 
SELECT 'fee', 'com_fee.fee', '{"special": {"dbtable": "#__fee_fee","key": "id","type": "fee","prefix":"FeeTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common": {"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"},"special":{}}', 'FeeHelperRoute::getFeeRoute', '{"formFile":"administrator\\/components\\/com_fee\\/models\\/forms\\/fee.xml", "hideFields": ["asset_id","checked_out","checked_out_time","access"], "ignoreChanges": [ "checked_out", "checked_out_time"],"convertToInt": [], "displayLookup": [{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"student_alias","targetTable":"#__fee_student","targetColumn":"alias","displayColumn":"title"},{"sourceColumn":"semester_alias","targetTable":"#__fee_semester","targetColumn":"alias","displayColumn":"title"},{"sourceColumn":"year_alias","targetTable":"#__fee_year","targetColumn":"alias","displayColumn":"start"}]}'
FROM DUAL
WHERE NOT EXISTS (SELECT `type_alias` FROM `#__content_types` WHERE `type_alias`='com_fee.fee');

/** Support Content history 
	receipt
**/
INSERT INTO `#__content_types` (`type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) 
SELECT 'fee', 'com_fee.receipt', '{"special": {"dbtable": "#__fee_receipt","key": "id","type": "receipt","prefix":"FeeTable","config":"array()"},"common":{"dbtable":"#__ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common": {"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"},"special":{}}', 'FeeHelperRoute::getReceiptRoute', '{"formFile":"administrator\\/components\\/com_fee\\/models\\/forms\\/receipt.xml", "hideFields": ["asset_id","checked_out","checked_out_time","access"], "ignoreChanges": [ "checked_out", "checked_out_time"],"convertToInt": [], "displayLookup": [{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"student_alias","targetTable":"#__fee_student","targetColumn":"alias","displayColumn":"title"},{"sourceColumn":"semester_alias","targetTable":"#__fee_semester","targetColumn":"alias","displayColumn":"title"},{"sourceColumn":"year_alias","targetTable":"#__fee_year","targetColumn":"alias","displayColumn":"start"}]}'
FROM DUAL
WHERE NOT EXISTS (SELECT `type_alias` FROM `#__content_types` WHERE `type_alias`='com_fee.receipt');
...
(5, 246, 5, 1, 0, '0000-00-00 00:00:00', 668, '339BEE83-8555-4B56-A665-BA99F1460496', 'Tại chức');
...
(4, 250, 4, 1, 0, '0000-00-00 00:00:00', 668, 'AA54A99B-B1C2-40AF-A577-0ACA55672E8F', 'Cả năm');