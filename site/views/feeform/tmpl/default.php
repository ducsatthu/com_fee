...
<script type="text/javascript">
    if (jQuery === 'undefined') {
        document.addEventListener("DOMContentLoaded", function(event) { 
            jQuery('#form-fee').submit(function(event) {
...
<div class="fee-edit front-end-edit">
    ...
    <form id="form-fee" action="<?php echo JRoute::_('index.php?option=com_fee&task=fee.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
		...
		<div class="controls"><?php echo $this->form->getInput('owed'); ?></div>
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-fee").appendChild(input);
                    });
                </script>
             <?php endif; ?>
        <div class="control-group">
            <div class="controls">
                ...
                <a class="btn" href="<?php echo JRoute::_('index.php?option=com_fee&task=feeform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
            </div>
        </div>
        
        <input type="hidden" name="option" value="com_fee" />
        <input type="hidden" name="task" value="feeform.save" />
