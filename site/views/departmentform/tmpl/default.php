...
<div class="department-edit front-end-edit">
    ...
    <form id="form-department" action="<?php echo JRoute::_('index.php?option=com_fee&task=department.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<?php foreach((array)$this->item->department_alias as $value): ?>
		...
		<?php endif; ?>
	<?php endforeach; ?>				<div class="fltlft" <?php if (!JFactory::getUser()->authorise('core.admin','fee')): ?> style="display:none;" <?php endif; ?> >
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-department").appendChild(input);
                    });
                </script>
             <?php endif; ?>
        <div class="control-group">
            <div class="controls">
                ...
                <a class="btn" href="<?php echo JRoute::_('index.php?option=com_fee&task=departmentform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
            </div>
        </div>
