 ...
 */
class FeeControllerReceipt extends FeeController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Receipt', 'FeeModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_fee') || $user->authorise('core.edit.state', 'com_fee')) {
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_fee&view=receipts', false));
            } else {
